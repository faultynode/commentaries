...
Corpus: **50 commentaries**, 2,765,621 words, 3832 sections indexed in `synthesis/corpus.json`.
...
- ... 44 more; see `synthesis_query.py --theme konstitution`
...
- ... 40 more; see `synthesis_query.py --theme leib`
...
- ... 23 more; see `synthesis_query.py --theme vorhandenheit`
...
- ... 42 more; see `synthesis_query.py --theme zeitlichkeit`
