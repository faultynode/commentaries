...
Corpus: **52 commentaries**, 2,925,710 words, 3900 sections indexed in `synthesis/corpus.json`.
...
- ... 40 more; see `synthesis_query.py --theme intentionalitaet`
...
- ... 46 more; see `synthesis_query.py --theme konstitution`
...
- ... 42 more; see `synthesis_query.py --theme leib`
